...
static const _NextGoal_Request_type_support_symbol_names_t _NextGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, NextGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, NextGoal_Request)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::NextGoal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_robot_interfaces, srv, NextGoal_Request)() {
  return get_message_type_support_handle<my_robot_interfaces::srv::NextGoal_Request>();
}
...
static const _NextGoal_Response_type_support_symbol_names_t _NextGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, NextGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, NextGoal_Response)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::NextGoal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_robot_interfaces, srv, NextGoal_Response)() {
  return get_message_type_support_handle<my_robot_interfaces::srv::NextGoal_Response>();
}
...
static const _NextGoal_type_support_symbol_names_t _NextGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, NextGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, NextGoal)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::NextGoal_service_type_support_handle;
}
